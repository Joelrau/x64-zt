...
namespace zonetool::iw6
{
	...
	void IGfxWorld::write(IZone* zone, ZoneBuffer* buf)
	{
		...
		if (data->lightGrid.tree.p_nodeTable)
		{
			...
			ZoneBuffer::clear_pointer(&dest->lightGrid.tree.p_nodeTable);
		}
		...
		if (data->lightGrid.tree.p_leafTable)
		{
			...
			ZoneBuffer::clear_pointer(&dest->lightGrid.tree.p_leafTable);
		}
