	...
	namespace converter::h1
	{
		namespace scriptfile
		{
			...
			std::string convert_name(std::string gsc_name)
			{
				...
				{
					const auto name = gsc::iw6::gsc_ctx->token_name(std::atoi(gsc_name.data()));
			...
			{
				auto& decompiler = gsc::iw6::gsc_ctx->decompiler();
				auto& disassembler = gsc::iw6::gsc_ctx->disassembler();
