...
namespace zonetool::iw7
{
	...
	public:
		...
		static void write_info(zone_base* zone, zone_buffer* buf, ClipInfo* data, ClipInfo* dest);
		static void parse_info(ClipInfo* info, assetmanager::reader& read, zone_memory* mem);
