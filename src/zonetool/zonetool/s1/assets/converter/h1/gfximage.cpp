...
{
	namespace converter::h1::gfximage
	{
		namespace
		{
		...
		{
			const auto stream_file_index = *reinterpret_cast<unsigned int*>(0x141E57A04);
			const auto stream_files = reinterpret_cast<XStreamFile*>(0x141E57A30);
