...
namespace zonetool::s1
{
	...
	enum MaterialVertexDeclType : std::int32_t
	{
		...
		VERTDECL_PACKED = 0x1,
		VERTDECL_PACKED_HDR = 0x2,
		VERTDECL_PACKED_REACTIVEMOTION = 0x3,
		VERTDECL_PACKED_VERTLIT = 0x4,
		VERTDECL_PACKED_MLMAP = 0x5,
		VERTDECL_QUANTIZED = 0x6,
		VERTDECL_QUANTIZED_NOCOLOR = 0x7,
		VERTDECL_QUANTIZED_NOCOLOR_REACTIVEMOTION = 0x8,
		VERTDECL_QUANTIZED_VERTLIT = 0x9,
		VERTDECL_QUANTIZED_NOCOLOR_VERTLIT = 0xA,
		VERTDECL_QUANTIZED_MLMAP = 0xB,
		VERTDECL_QUANTIZED_NOCOLOR_MLMAP = 0xC,
		VERTDECL_QUANTIZED_SKINNED_CACHED_MODEL = 0xD,
		VERTDECL_QUANTIZED_SKINNED_CACHED_NOCOLOR_MODEL = 0xE,
		VERTDECL_QUANTIZED_SKINNED_MODEL = 0xF,
		VERTDECL_QUANTIZED_SKINNED_NOCOLOR_MODEL = 0x10,
		VERTDECL_WORLD = 0x11,
		VERTDECL_WORLD_POS = 0x11,
		VERTDECL_WORLD_WORLDVERT_FIRST = 0x11,
		VERTDECL_WORLD_WORLDVERT_LAST = 0x1C,
		VERTDECL_POS_TEX = 0x1D,
		VERTDECL_COUNT = 0x1E,
	};
	...
	enum MaterialStreamRoutingSource : std::int32_t
	{
		...
		STREAM_SRC_MODEL_LMAP_COORDS = 0x9,
	...
	enum MaterialStreamRoutingDestination : std::int32_t
	{
		...
		STREAM_DST_COLOR_2 = 0x10,
		STREAM_DST_COLOR_3 = 0x11,
		STREAM_DST_COLOR_COUNT = 0x4,
	};
