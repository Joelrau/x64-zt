...
#define DEFINE_FIELD(__name__) {#__name__, static_cast<unsigned short>(offsetof(WeaponDef, __name__))}
		...
		std::unordered_map<std::string, unsigned short> weapon_def_fields =
		{
			...
			DEFINE_FIELD(unkVec1[0]),
			DEFINE_FIELD(unkVec1[1]),
			DEFINE_FIELD(unkVec1[2]),
			DEFINE_FIELD(unkVec2[0]),
			DEFINE_FIELD(unkVec2[1]),
			DEFINE_FIELD(unkVec2[2]),
			...
			DEFINE_FIELD(originalAccuracyGraphKnotCount[0]),
			DEFINE_FIELD(originalAccuracyGraphKnotCount[1]),
			...
			//DEFINE_FIELD(__pad[0]),
			//DEFINE_FIELD(__pad[1]),
			//DEFINE_FIELD(__pad[2]),
			//DEFINE_FIELD(__pad[3]),
			//DEFINE_FIELD(__pad[4]),
			//DEFINE_FIELD(__pad[5]),
			//DEFINE_FIELD(__pad[6]),
			//DEFINE_FIELD(__pad[7]),
			//DEFINE_FIELD(__pad[8]),
			//DEFINE_FIELD(__pad[9]),
			//DEFINE_FIELD(__pad[10]),
			//DEFINE_FIELD(__pad[11]),
			//DEFINE_FIELD(__pad[12]),
			//DEFINE_FIELD(__pad[13]),
			//DEFINE_FIELD(__pad[14]),
			//DEFINE_FIELD(__pad[15]),
