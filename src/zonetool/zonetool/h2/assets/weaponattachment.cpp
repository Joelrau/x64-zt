...
#define DEFINE_FIELD(__name__) {#__name__, static_cast<unsigned short>(offsetof(WeaponDef, __name__))}
	...
	std::unordered_map<std::string, unsigned short> weapon_def_fields =
	{
		...
		DEFINE_FIELD(szAttachmentName),
		DEFINE_FIELD(szUnknownName),
		...
		DEFINE_FIELD(fireSoundPlayerLeft),
		DEFINE_FIELD(fireSoundPlayerRight),
		DEFINE_FIELD(sound14),
		DEFINE_FIELD(sound15),
		DEFINE_FIELD(sound16),
		DEFINE_FIELD(sound17),
		DEFINE_FIELD(sound18),
		DEFINE_FIELD(fireLoopSound),
		DEFINE_FIELD(fireLoopSoundPlayer),
		DEFINE_FIELD(sound21),
		DEFINE_FIELD(sound22),
		DEFINE_FIELD(sound23),
		DEFINE_FIELD(sound24),
		DEFINE_FIELD(sound25),
		DEFINE_FIELD(sound26),
		DEFINE_FIELD(fireStopSound),
		DEFINE_FIELD(fireStopSoundPlayer),
		DEFINE_FIELD(sound29),
		DEFINE_FIELD(sound30),
		DEFINE_FIELD(sound31),
		DEFINE_FIELD(sound32),
		DEFINE_FIELD(sound33),
		DEFINE_FIELD(fireFirstSound),
		DEFINE_FIELD(fireFirstSoundPlayer),
		DEFINE_FIELD(fireSound2),
		DEFINE_FIELD(fireSoundPlayer2),
		DEFINE_FIELD(fireSpecialSound),
		DEFINE_FIELD(fireSpecialSoundPlayer),
		DEFINE_FIELD(emptyFireSound),
		DEFINE_FIELD(emptyFireSoundPlayer),
		DEFINE_FIELD(emptyFireSoundPlayerLeft),
		DEFINE_FIELD(emptyFireSoundPlayerRight),
		DEFINE_FIELD(emptyFireSoundReleasePlayer),
		DEFINE_FIELD(emptyFireSoundReleasePlayerLeft),
		DEFINE_FIELD(emptyFireSoundReleasePlayerRight),
		DEFINE_FIELD(sound47),
		...
		DEFINE_FIELD(sound54),
		DEFINE_FIELD(sound55),
		DEFINE_FIELD(sound56),
		DEFINE_FIELD(sound57),
		DEFINE_FIELD(sound58),
		DEFINE_FIELD(sound59),
		DEFINE_FIELD(sound60),
		DEFINE_FIELD(sound61),
		DEFINE_FIELD(sound62),
		DEFINE_FIELD(sound63),
		...
		DEFINE_FIELD(raiseSoundPlayerLeft),
		DEFINE_FIELD(raiseSoundPlayerRight),
		DEFINE_FIELD(sound74),
		DEFINE_FIELD(quickRaiseSoundPlayer),
		DEFINE_FIELD(quickRaiseSoundPlayerLeft),
		DEFINE_FIELD(quickRaiseSoundPlayerRight),
		DEFINE_FIELD(raiseSound2),
		DEFINE_FIELD(sound79),
		DEFINE_FIELD(sound80),
		DEFINE_FIELD(sound81),
		DEFINE_FIELD(putawaySound),
		DEFINE_FIELD(putawaySoundPlayer),
		DEFINE_FIELD(putawaySoundPlayerLeft),
		DEFINE_FIELD(putawaySoundPlayerRight),
		DEFINE_FIELD(sound86),
		DEFINE_FIELD(sound87),
		...
		DEFINE_FIELD(turretBarrelSpinUpSnd),
		DEFINE_FIELD(turretBarrelSpinDownSnd),
		...
		DEFINE_FIELD(standMove),
		DEFINE_FIELD(standRot),
		DEFINE_FIELD(strafeMove),
		DEFINE_FIELD(strafeRot),
		DEFINE_FIELD(duckedOfs),
		DEFINE_FIELD(duckedMove),
		DEFINE_FIELD(duckedRot),
		DEFINE_FIELD(proneOfs),
		DEFINE_FIELD(proneMove),
		DEFINE_FIELD(proneRot),
		DEFINE_FIELD(unkVec1),
		DEFINE_FIELD(unkVec2),
		...
		DEFINE_FIELD(stateTimers.u75),
		DEFINE_FIELD(stateTimers.u76),
		DEFINE_FIELD(stateTimers.u77),
		DEFINE_FIELD(stateTimers.u78),
		...
		DEFINE_FIELD(akimboStateTimers.u75),
		DEFINE_FIELD(akimboStateTimers.u76),
		DEFINE_FIELD(akimboStateTimers.u77),
		DEFINE_FIELD(akimboStateTimers.u78),
		...
		DEFINE_FIELD(overlay.xU_01),
		DEFINE_FIELD(overlay.xU_02),
		...
		DEFINE_FIELD(accuracyGraphName),
		DEFINE_FIELD(accuracyGraphKnots),
		DEFINE_FIELD(originalAccuracyGraphKnots),
		DEFINE_FIELD(accuracyGraphKnotCount),
		...
		DEFINE_FIELD(minTurnSpeed),
		DEFINE_FIELD(maxTurnSpeed),
