...
#undef READ_PHYSMASS_ARR
		...
		void parse_veh_phys_def(VehiclePhysDef* vehicle, ordered_json& data, zone_memory* mem)
		{
			...
			VEHICLE_READ_FIELD(float, unk_float1); // 0.0010000000474974513
			VEHICLE_READ_FIELD(float, unk_float2); // 1.0
			VEHICLE_READ_FIELD(float, unk_float3); // 1.0
		}
	}
	...
	VehicleDef* vehicle_def::parse(const std::string& name, zone_memory* mem)
	{
		...
		VEHICLE_READ_FIELD(float, unk_float1); // 1000.0
		VEHICLE_READ_FIELD(float, unk_float2); // 0.0
...
#undef DUMP_PHYSMASS_ARR
	...
	void dump_veh_phys_def(VehiclePhysDef* asset, ordered_json& data)
	{
		...
		VEHICLE_DUMP_FIELD(unk_float1);
		VEHICLE_DUMP_FIELD(unk_float2);
		VEHICLE_DUMP_FIELD(unk_float3);
	}
