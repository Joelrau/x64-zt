...
namespace zonetool::h2
{
	...
	enum GfxCameraRegionType : std::uint8_t
	{
		...
		CAMERA_REGION_POST_MOTIONBLUR = 0x5,
		CAMERA_REGION_DEPTH_HACK = 0x6,
		CAMERA_REGION_DEPTH_HACK_SSS = 0x7,
		CAMERA_REGION_LIGHT_MAP_OPAQUE = 0x8,
		CAMERA_REGION_DEPTH_HACK_DOF = 0x9,
		CAMERA_REGION_MOTIONBLUR = 0xA,
		CAMERA_REGION_POST_RESOLVE_LIT = 0xB,
		CAMERA_REGION_THERMAL_MASK = 0xC,
		CAMERA_REGION_POSTFX_SURFACE_HACK = 0xD,
		CAMERA_REGION_COUNT = 0xE,
		CAMERA_REGION_NONE = 0xE,
	};
	...
	enum FxElemLitType : std::uint8_t
	{
		...
		FX_ELEM_LIT_TYPE_LIGHTGRID_SPAWN_SPRITE = 0x2,
		FX_ELEM_LIT_TYPE_LIGHTGRID_FRAME_SINGLE = 0x3,
		FX_ELEM_LIT_TYPE_LIGHTGRID_FRAME_SPRITE = 0x4,
		FX_ELEM_LIT_TYPE_LIGHTGRID_FRAME_VERTEX = 0x5,
		FX_ELEM_LIT_TYPE_COUNT = 0x6,
	};
	...
	enum FxElemDefExtraFlags : std::uint32_t
	{
		...
		FX_ELEM2_REQUIRES_POST_RESOLVE_DRAW = 0x40,
		FX_ELEM2_DECAL_EXPONENTIAL_FADE_OUT = 0x80,
		FX_ELEM2_INVALID_DONT_USE = 0x80,
		FX_ELEM2_USE_DOPL = 0x100,
		FX_ELEM2_USE_ITEM_CLIP = 0x200,
		FX_ELEM2_RUN_RELATIVE_TO_OFFSET = 0x400,
		FX_ELEM2_HIGH_PRI_SHADOW = 0x800,
		FX_ELEM2_DISABLE_SHADOW = 0x1000,
		FX_ELEM2_DRAW_DPVS_CULL = 0x2000,
		FX_ELEM2_DRAW_IN_NVG_VIEW = 0x4000,
		FX_ELEM2_NODRAW_IN_NVG_VIEW = 0x8000,
		FX_ELEM2_LIGHTGRID_DIRECTIONAL_FETCH = 0x10000,
		FX_ELEM2_HAS_PARENT_VELOCITY = 0x20000,
		FX_ELEM2_THERMAL_OVERRIDES_MATERIAL = 0x40000,
		FX_ELEM2_BLOCK_OCCLUSION_QUERIES = 0x80000,
		FX_ELEM2_ENABLE_SPECULAR = 0x100000,
		FX_ELEM2_DETECT_WATER_CLIP = 0x200000,
		FX_ELEM2_ENABLE_TRAIL_DEPTH_SORT = 0x400000,
	};
	...
	enum weapAnimFiles_t : std::int32_t
	{
		...
		WEAP_ANIM_MELEE_ALT_STANDING,
		WEAP_ANIM_MELEE_ALT_CROUCHING,
		WEAP_ANIM_MELEE_ALT_PRONE,
		WEAP_ANIM_MELEE_ALT_JUMPING,
		WEAP_ANIM_MELEE_ALT_STANDING_VICTIM_CROUCHING,
		WEAP_ANIM_MELEE_ALT_CROUCHING_VICTIM_CROUCHING,
		WEAP_ANIM_MELEE_ALT_PRONE_VICTIM_CROUCHING,
		WEAP_ANIM_MELEE_ALT_JUMPING_VICTIM_CROUCHING,
		WEAP_ANIM_RELOAD,
		WEAP_ANIM_UNK_26,
		WEAP_ANIM_RELOAD_EMPTY, // UNK_28 & UNK_29 after this
		WEAP_ANIM_UNK_28, // might not be in the right spot
		WEAP_ANIM_UNK_29, // ^
		...
		WEAP_ANIM_DUALMAG_RELOAD,
		WEAP_ANIM_DUALMAG_RELOAD_EMPTY,
		WEAP_ANIM_SPEED_RELOAD,
		WEAP_ANIM_RELOAD_FROM_ALT,
		WEAP_ANIM_RAISE, // UNK_28 & UNK_29 before this
		...
		WEAP_ANIM_HYBRID_SIGHT_ON,
		WEAP_ANIM_HYBRID_SIGHT_OFF,
		WEAP_ANIM_SPRINT_IN,
		WEAP_ANIM_SPRINT_IN_FROM_SLIDE,
		WEAP_ANIM_SPRINT_IN_CANCEL,
		WEAP_ANIM_SPRINT_LOOP,
		WEAP_ANIM_SPRINT_OUT,
		WEAP_ANIM_SPRINTANDFIRE_IN,
		WEAP_ANIM_SPRINTANDFIRE_LOOP,
		WEAP_ANIM_SPRINTANDFIRE_OUT,
		...
		WEAP_ANIM_SLIDE_IN,
		WEAP_ANIM_SLIDE_LOOP,
		WEAP_ANIM_SLIDE_OUT_TO_SPRINT,
		WEAP_ANIM_SLIDE_OUT,
		WEAP_ANIM_SLIDE_AND_FIRE_IN,
		WEAP_ANIM_SLIDE_AND_FIRE_LOOP,
		WEAP_ANIM_SLIDE_AND_FIRE_OUT,
		WEAP_ANIM_HIGH_JUMP_IN,
		WEAP_ANIM_HIGH_JUMP_DROP_IN,
		WEAP_ANIM_HIGH_JUMP_DROP_LOOP,
		WEAP_ANIM_HIGH_JUMP_DROP_LAND,
		...
		WEAP_ANIM_SWIM_LOOP,
		WEAP_ANIM_MANTLE_UP_64,
		WEAP_ANIM_MANTLE_UP_56,
		WEAP_ANIM_MANTLE_UP_48,
		WEAP_ANIM_MANTLE_UP_40,
		WEAP_ANIM_MANTLE_UP_32,
		WEAP_ANIM_MANTLE_UP_24,
		WEAP_ANIM_MANTLE_UP_16,
		WEAP_ANIM_MANTLE_OVER_64,
		WEAP_ANIM_MANTLE_OVER_56,
		WEAP_ANIM_MANTLE_OVER_48,
		WEAP_ANIM_MANTLE_OVER_40,
		WEAP_ANIM_MANTLE_OVER_32,
		WEAP_ANIM_MANTLE_OVER_24,
		WEAP_ANIM_MANTLE_OVER_16,
		WEAP_ANIM_GOLIATH_ENTRY,
		WEAP_ANIM_OFFHAND_SWITCH,
		WEAP_ANIM_HEAT_COOLDOWN_IN,
		WEAP_ANIM_HEAT_COOLDOWN_OUT,
		WEAP_ANIM_OVERHEAT_OUT,
		WEAP_ANIM_SCRIPTED,
		WEAP_ANIM_INSPECTION,
		WEAP_ANIM_UNK_117,
		WEAP_ANIM_UNK_118,
		WEAP_ANIM_UNK_119,
		WEAP_ANIM_UNK_120,
		...
		WEAP_ANIM_ADDITIVE_HYBRID_SIGHT_UP_ROOT,
		WEAP_ANIM_ADDITIVE_HYBRID_SIGHT_UP,
		...
		WEAP_ANIM_ADDITIVE_JUMP_LAND_HEAVY,
		WEAP_ANIM_ADDITIVE_WALK_ROOT,
		WEAP_ANIM_ADDITIVE_WALK,
		WEAP_ANIM_UNK_166,
		WEAP_ANIM_UNK_167,
		WEAP_ANIM_ADDITIVE_HEAT_COOLDOWN_LOOP_ROOT,
		WEAP_ANIM_ADDITIVE_HEAT_COOLDOWN_LOOP,
		WEAP_ANIM_ADDITIVE_OVERHEAT_IN_ROOT,
		WEAP_ANIM_ADDITIVE_OVERHEAT_IN,
		WEAP_ANIM_ADDITIVE_OVERHEAT_LOOP_ROOT,
		WEAP_ANIM_ADDITIVE_OVERHEAT_LOOP,
		...
		WEAP_ANIM_ADDITIVE_CRAWL_LOOP_BACK_ROOT,
		WEAP_ANIM_ADDITIVE_CRAWL_LOOP_BACK,
		...
		WEAP_ANIM_ADDITIVE_MANTLE_ROOT,
		WEAP_ANIM_ADDITIVE_MANTLE,
		WEAP_ANIM_ADDITIVE_LOW_MANTLE_ROOT,
		WEAP_ANIM_ADDITIVE_MANTLE_UP_24,
		WEAP_ANIM_ADDITIVE_MANTLE_UP_16,
		WEAP_ANIM_ADDITIVE_MANTLE_OVER_24,
		WEAP_ANIM_ADDITIVE_MANTLE_OVER_16,
		WEAP_ANIM_ADDITIVE_SHOT_CHARGE_IN_ROOT,
		WEAP_ANIM_ADDITIVE_SHOT_CHARGE_IN,
		WEAP_ANIM_ADDITIVE_SHOT_CHARGE_LOOP_ROOT,
		WEAP_ANIM_ADDITIVE_SHOT_CHARGE_LOOP,
		WEAP_ANIM_ADDITIVE_SCRIPTED_ROOT,
		WEAP_ANIM_ADDITIVE_SCRIPTED,
		WEAP_ANIM_UNK_201,
		WEAP_ANIM_UNK_202,
		NUM_WEAP_ANIMS = 202,
	};
