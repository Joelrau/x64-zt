...
namespace zonetool::h1
{
	...
	enum MaterialVertexDeclType : std::int32_t
	{
		VERTDECL_GENERIC = 0,
		VERTDECL_PACKED = 1,
		VERTDECL_PACKED_HDR = 2,
		VERTDECL_PACKED_REACTIVEMOTION = 3,
		VERTDECL_PACKED_VERTLIT = 4,
		VERTDECL_PACKED_MLMAP = 5,
		VERTDECL_QUANTIZED = 6,
		VERTDECL_QUANTIZED_NOCOLOR = 7,
		VERTDECL_QUANTIZED_NOCOLOR_REACTIVEMOTION = 8,
		VERTDECL_UNK9 = 9,
		VERTDECL_QUANTIZED_VERTLIT = 10,
		VERTDECL_QUANTIZED_NOCOLOR_VERTLIT = 11,
		VERTDECL_QUANTIZED_MLMAP = 12,
		VERTDECL_QUANTIZED_NOCOLOR_MLMAP = 13,
		VERTDECL_WORLD = 14,
		VERTDECL_WORLD_POS = 14,
		VERTDECL_WORLD_WORLDVERT_FIRST = 14,
		VERTDECL_WORLD_WORLDVERT_LAST = VERTDECL_WORLD_WORLDVERT_FIRST + MTL_WORLDVERT_COUNT - 1,
		VERTDECL_UNK248 = 248,
		VERTDECL_UNK249 = 249,
		VERTDECL_COUNT = 250,
	};
	...
	enum MaterialTechniqueFlags : std::uint16_t
	{
		...
		MTL_TECHFLAG_UNK4 = 0x4,
		MTL_TECHFLAG_UNK8 = 0x8, // if ( (v6->technique->hdr.flags & 8) != 0 )
								 //     v10 = v6->material->techniqueSet->worldVertFormat + 14;
	};
