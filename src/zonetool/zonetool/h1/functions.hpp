...
namespace zonetool::h1
{
	...
	WEAK::h1::game::symbol<XAssetHeader(XAssetType type, const char* name, int createDefault)> DB_FindXAssetHeader{ 0x1402BAC70 };
	WEAK::h1::game::symbol<XAssetEntry* (XAssetType type, const char* name)> DB_FindXAssetEntry{ 0x1402BABA0 };
	WEAK::h1::game::symbol<bool(XAssetType, const char* name)> DB_IsXAssetDefault{ 0x1402BC370 };
	...
	WEAK::h1::game::symbol<char* (scr_string_t stringValue)> SL_ConvertToString{ 0x14043B170 };
}