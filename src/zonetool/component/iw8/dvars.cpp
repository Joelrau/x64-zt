...
namespace iw8
{
	namespace dvars
	{
		...
		public:
			...
			{
				dvar_register_bool_hook.create(0x13E7670_b, &dvar_register_bool);
			...
			{
				return component_priority(1);
			}
		};
	}
}

REGISTER_COMPONENT_IW8(iw8::dvars::component)
