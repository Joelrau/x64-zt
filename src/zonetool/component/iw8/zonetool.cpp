...
namespace iw8
{
	namespace zonetool
	{
		...
		void load_code_pre_gfx_zone()
		{
			...
			return ::zonetool::iw8::DB_LoadXAssets(&zone, 1, ::zonetool::iw8::DB_LOAD_SYNC);
		}
		...
		void load_common_zones()
		{
			...
			return ::zonetool::iw8::DB_LoadXAssets(zones, static_cast<unsigned int>(defaultzones.size()), ::zonetool::iw8::DB_LOAD_SYNC);
		}
		...
		public:
			void post_unpack() override
			{
				...
				utils::hook::call(0x141941A54, load_init_zones_stub);
				...
				// disable demonware
				utils::hook::set<uint8_t>(0x1414EF270, 0xC3); // dwNetStart

				// don't load streamed assets
				//utils::hook::set<uint8_t>(0x140A79AE0, 0xC3);
				utils::hook::set<uint8_t>(0x140D8FBD0, 0xC3); // DB_StreamingInfo_Register (iw7 sorta similar)
