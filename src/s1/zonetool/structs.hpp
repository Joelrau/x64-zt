...
namespace zonetool::s1
{
	...
	assert_offsetof(FxElemDef, velSamples, 192);
	assert_offsetof(FxElemDef, velIntervalCount, 183);
	assert_sizeof(FxElemVelStateSample, 96);

	assert_offsetof(FxElemDef, visSamples, 200);
	assert_offsetof(FxElemDef, visStateIntervalCount, 184);
	assert_sizeof(FxElemVisStateSample, 112);
